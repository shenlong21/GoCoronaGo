...
class Tiffin_service_model extends Model
{
    protected $table      = 'tiffin_service';
    ...
    public function find_tiffin_service_in_city($city) {
    ...
    public function find_tiffin_service_with_pin($pin) {
