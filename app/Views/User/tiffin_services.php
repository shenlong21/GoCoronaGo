...
<?= $this->section('head') ?>
    <title>Tiffin Services - User Panel - Go Corona Go</title>
...
<?= $this->section('content') ?>
    ...
    <div class="m-3" >
        ...
        <h5 class="h5 my-3"><strong>TIFFIN SERVICES </strong></h5>
        ...
        <div class="collapse my-3 col-lg-9 col-md-11 col-sm-12 col-xl-7 mx-lg-5 mb-4" id="oxygen-supplier-form">
            ...
            <form  method="post" action = "<?= base_url('/user/add_tiffin_supply') ?>">
                <div class="row mb-3">
                ...
                <div class="d-flex justify-content-end pb-4">
                    <button type="submit" class="btn border" id="submit">Add Service</button>
                </div>
            </form>
            <hr>
        </div>
        ...
        <div class="h6">CURRENT SERVICES</div>
    ...
    <div class="m-3 pt-4">
        <h5 class="h6" style="font-weight:650;">LAST 20 ACTIVITIES IN TIFFIN SERVICES:</h5>
        <?php
...
<?= $this->section('script') ?>
    <script>
        ...
        function open_delete_diag(id) {
            ...
            $("#model-footer").html(`
                <form method='post' action='del_tiffin_supplier'>
